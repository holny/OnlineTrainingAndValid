...
app.config['CELERY_BROKER_URL'] = 'redis://:redispassword@localhost:6379/1'
# 要存储 Celery 任务的状态或运行结果时就必须要配置
app.config['CELERY_RESULT_BACKEND'] = 'redis://:redispassword@localhost:6379/1'
...
# 建立数据库连接池
dbPool = PooledDB(pymysql, 5, host='127.0.0.1', user='root', passwd='mysqlpassword', db='hwr', port=3306)  # 5为连接池里的最少连接数
